...
myApp.factory('customerServices', ['$http', function($http) {
    ...
    var factoryDefinitions = {
	  getCustomers: function(API_BASE_URL) {
		  console.log("API_BASE_URL "+API_BASE_URL);
		return $http.get(API_BASE_URL+'/pageConfigService/getPageConfigList?store_id=1&brand_id=&language=en').success(function(data) { return data; });
...
//Controllers
myApp.controller('getCustomersController', ['$scope', 'customerServices', 'dataTable', 'API_BASE_URL', function($scope, customerServices, dataTable, API_BASE_URL) {

	customerServices.getCustomers(API_BASE_URL).then(function(result){
